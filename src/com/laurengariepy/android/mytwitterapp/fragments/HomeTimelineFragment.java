...
/**
 * Class represents a home timeline of tweets available through the Twitter REST API
 */
public class HomeTimelineFragment extends TweetsListFragment {
	...
	protected void makeAsyncHttpRequest(int totalItemsCount) {
		...
		MyTwitterAppActivity.getRestClient().getHomeTimeline(totalItemsCount, maxId, new TwitterListViewHandler());
	}
